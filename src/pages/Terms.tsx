          ...
          <Card>
            ...
            <CardContent className="prose prose-slate dark:prose-invert max-w-none space-y-6">
              ...
              <section>
                ...
                <p>
                  By creating an account and using LockedContent, you agree to be bound by these Terms of Service. 
              ...
              <section>
                ...
                <p className="mb-3">
                  LockedContent allows users to upload and share video content. By using our platform, you acknowledge and agree that:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>You are solely responsible for any content you upload, share, or post on our platform</li>
                  <li>LockedContent is not responsible for user-generated content and does not endorse, support, or guarantee the accuracy of any user content</li>
              ...
              <section>
                ...
                <p className="mb-3">
                  <strong>IMPORTANT:</strong> LockedContent operates as a platform that enables users to share content with each other. 
                  We do not pre-screen, monitor, or control user-generated content. Therefore:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>LockedContent is not liable for any user-generated content posted on our platform</li>
              ...
              <section>
                ...
                <p>You agree not to use LockedContent to:</p>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                ...
                <p>
                  LockedContent shall not be liable for any indirect, incidental, special, consequential, or punitive damages 
              ...
              <section>
                ...
                <p>
                  We reserve the right to modify these terms at any time. Continued use of LockedContent after changes 
